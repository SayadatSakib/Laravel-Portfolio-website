            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    	...
                    	<li> <a href="{{url('/course')}}" ><span> <i class="fas fa-book"></i></span><span class="hide-menu">Courses</span></a></li>

                        <li> <a href="{{url('/project')}}" ><span> <i class="fas fa-laptop-code"></i> </span><span class="hide-menu">Projects</span></a></li>

                        <li> <a href="{{url('/contact')}}" ><span> <i class="fas fa-envelope"></i> </span><span class="hide-menu">Contacts</span></a></li>

                        <li> <a href="{{url('/review')}}" ><span> <i class="fas fa-comments"></i> </span><span class="hide-menu">Reviews</span></a></li>

                        <li> <a href="{{url('/gallery')}}" ><span> <i class="fas fa-image"></i> </span><span class="hide-menu">Gallery</span></a></li>
					</ul>
                </nav>
            </div>
        </aside>
